<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-03-29 12:16:02
         compiled from "./templates/inquiry_edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:158632718556f0a2b94cef85-38201493%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '110ccd5f447df1bf2ead794b42fab131618d6b17' => 
    array (
      0 => './templates/inquiry_edit.tpl',
      1 => 1459154723,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '158632718556f0a2b94cef85-38201493',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_56f0a2b95aaa77_68050212',
  'variables' => 
  array (
    'isError' => 0,
    'errMessage' => 0,
...
<?php if ($_valid && !is_callable('content_56f0a2b95aaa77_68050212')) {function content_56f0a2b95aaa77_68050212($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="pageTitle">
<div id="wrapper">
かんたん相談フォーム<div class="returnBt"><a href="javascript:history.back();">前のページに戻る</a></div>
</div>
</div>
...
<div id="wrapper">
<div class="entryform">
<form action="/inquiry/check" method="post" class="inquiryForm">
...
<td class="<?php if ($_smarty_tpl->tpl_vars['isError']->value['detail']) {?>redBackground<?php }?>">
    <?php if ($_smarty_tpl->tpl_vars['isError']->value['detail']) {?>
    <div class="req"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['errMessage']->value['detail'], ENT_QUOTES, 'UTF-8', true);?>
</div>
    <?php }?>  
<textarea name="detail" placeholder="例："><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['formData']->value['detail'], ENT_QUOTES, 'UTF-8', true);?>
</textarea>
</td>
</tr>
