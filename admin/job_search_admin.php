...
//担当
$searchParams['centralManagerList'] = AdminDataConvertUtil::makeSelectList($gvSortCentralManager, $gvCentralManager);

$view = new ViewAdmin();
$view->displayJobSearch($searchParams);
