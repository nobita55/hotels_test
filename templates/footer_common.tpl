...
<div class="entryArea">
    ...
    <div class="entryAction">
        <div class="entryTelBg">
            ...
            <!--  entryTel  --></div>
        <!--  entryTelBg  -->
        <div class="entryTelCom"><span class="telHours">受付：</span>月～金曜10～19時 土曜10～17時</div>
        <!--  entryTelCom  -->
        ...
        <!--  entryWeb  --></div>
    <!--  entryAction  -->
    <div class="entrySpot">お問い合わせ時点でのキャンセルは可能です。<br>掲載以外にも<a href="https://hotelsjob.net/"
        class="hiddenLink">ホテルの仕事</a>が多数あります。<span class="feelFree">お気軽にお問い合わせください。</span></div>
    <!--  entrySpot  --> 
</div>
<!--  entryArea  -->
...
<div id="footer">
    ...
    <div class="footerCopyRight"><i class="fa fa-copyright"></i> HOTELSWORK ALL RIGHTS RESERVED.</div>
</div>
<!-- / フッター -->