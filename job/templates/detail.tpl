...
<title>{$jobInfo.titleExcMark}-ホテルズワーク</title>
...
<div id="wrapper" itemscope itemtype="http://schema.org/JobPosting">
    ...
    <table>
		...
		<span itemprop="jobLocation" itemscope="" itemtype="http://schema.org/Place"><!--勤務地--> 
					<span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
					<meta itemprop="addressRegion" content="{$jobInfo.place}">
					</span> </span> <span itemprop="hiringOrganization" itemscope="" itemtype="http://schema.org/Organization"><!--勤務先企業-->
					<meta itemprop="name" content="株式会社セントラルクルー" >
					</span>
		</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{$jobInfo.feature}</td>
                            ...
                            <tr>
                <th>更新日</th>
                <td>{$smarty.now|date_format:'%Y/%m/%d'}<meta itemprop="datePosted" content="{$smarty.now|date_format:'%Y/%m/%d'}"></td>
                </tr>
            </tbody>
    </table>
