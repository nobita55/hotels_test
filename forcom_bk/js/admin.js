...
function ajaxLoadJobs(url, searchJobId, searchRecJobId) {
    var data = {mode: 'getJobs', searchJobId: searchJobId, searchRecJobId: searchRecJobId};
    $.ajax({
        type: "POST",
        url: url,
        dataType: "json",
...
function searchJob(url) {
    ...
    ajaxLoadJobs(url, searchJobId, searchRecJobId);
}
...
function configTemplate() {
    ...
    templates['tableSpJobsInSp'] = '<tr class="<%- job_id %>">' +
            ...
            '<td class="jobInSpHotelsName"><div><%- hotels_name %></div></td>' +
    ...
    templates['tableSpJobs'] = '<tr class="<%- id %>">' +
            ...
            '<td class="hotelsName "><%- hotels_name %></td>' +
    ...
    templates['tableSearchJobs'] = '<tr class="<%- id %>">' +
            ...
            '<a href="/job/detail/<%- id %>" class="euplink"  target="_blank">SITE</a> ' +
