            ...
            <table class="companyEntry">
                ...
                <tr>
                    ...
                    <td id="address" class="rightCell" colspan="2">
                        {if $formParams.jobAddressAll}{$formParams.jobAddressAll}{/if}
                    </td>
                </tr> 
                <!-- 職種 -->
                <tr>
                    ...
                    <td class="rightCell" colspan="2">
                            ...
                            部門：{$formParams.jobSection}<br />
                            職種：{$formParams.jobCategory}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="rightCell" colspan="2">
                        {$formParams.jobDetail|nl2br nofilter}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="rightCell" colspan="2">
                        {$formParams.shift|nl2br nofilter}
                    </td>
                </tr>
                <!-- 休日・休暇 -->
                <tr>
                    ...
                    <td class="rightCell" colspan="2">
                        {$formParams.holidayText|nl2br nofilter}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="rightCell" colspan="2">
                        {$formParams.employmentAll nofilter}
                    </td>
                </tr>                
                ...
                <tr>
                    ...
                    <td class="rightCell" colspan="2">
                        {$formParams.allowanceAll nofilter}
                    </td>
                </tr>  
                ...
                <tr>
                    ...
                    <td class="rightCell" colspan="2">
                        {$formParams.insuranceAll nofilter}
                    </td>
                </tr>  
                ...
                <tr>
                    ...
                    <td class="rightCell confirmSalary" colspan="2">
                            {if $formParams.salaryUnit!='0'}
                                {$formParams.salaryUnit}
                            {/if}
                            &yen;{$formParams.salaryMin}～&yen;{$formParams.salaryMax}
                            <br />
                            
                            賞与：{$formParams.bonusText}<br />
                            昇給：{$formParams.payriseText}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="rightCell" colspan="2">
                        {$formParams.billingDayAll nofilter}
                    </td>
                </tr> 
